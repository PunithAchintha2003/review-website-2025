...
const UploadFilmModel = ({ close, fetchData }) => {
            ...
            <div className='bg-white max-w-4xl w-full p-4 rounded-sm'>
                ...
                <form className='my-3 grid gap-2' onSubmit={handleSubmit}>
                    <div className='grid gap-1'>
                        <label htmlFor='filmTitle' className='text-black font-semibold'>Title</label>
                        <input
                            type='text'
                            id='filmTitle'
                            name='title'
                    ...
                    <div className='grid gap-1'>
                        <label htmlFor='filmDirector' className='text-black font-semibold'>Director</label>
                        <input
                            type='text'
                            id='filmDirector'
                            name='director'
...
UploadFilmModel.propTypes = {
    close: PropTypes.func.isRequired,
    fetchData: PropTypes.func.isRequired,
};

export default UploadFilmModel;